$(document).ready(function () {
    ...
    var url = "../SupBill/LoadSupBillList";
    var source =
    {
        datatype: "json",
        datafields:
        [
           { name: "SupBillId", type: "int" },
    ...
    var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
        ...
        cellHtml += "<a target=\"_self\" href=\"SupBillDetail?id=" + value + "\">明细</a>";

        cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"SupBillUpdate?id=" + value + "\">修改</a>";
    ...
    $("#jqxListGrid").jqxGrid(
    {
        ...
        columns: [
          { text: "操作", datafield: "SupBillId", cellsrenderer: cellsrenderer, width: 100, sortable: false, enabletooltips: false, menu: false, resizable: false, pinned: true },
          { text: "序号", cellsrenderer: numberrenderer, width: 40, sortable: false, enabletooltips: false, menu: false, resizable: false, pinned: true },
          { text: "供应商名称", datafield: "SupName", pinned: true, width: 150 },
