...
$(document).ready(function () {
    ...
    $("#jqxListGrid").jqxGrid(
    {
        ...
        columns: [
          ...
          { text: "应发工资", datafield: "TotalAmount", width: 70, cellsformat: "d2", editable: false },
          { text: "社保补交", datafield: "RepairAmount", width: 70, cellsformat: "d2" },
          { text: "税前工资", datafield: "GrossAmount", width: 70, cellsformat: "d2", editable: false },
          { text: "实发工资", datafield: "FinalAmount", width: 70, cellsformat: "d2", editable: false },
          { text: "服务费", datafield: "ServiceAmount", width: 70, cellsformat: "d2" },
          { text: "补收/退款", datafield: "RefundAmount", width: 70, cellsformat: "d2" },
          { text: "合计", datafield: "AllTotalAmount", width: 70, cellsformat: "d2", editable: false },
        ],
        columngroups: [
